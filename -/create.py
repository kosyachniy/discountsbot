...
with db:
	...
	db.execute("CREATE TABLE discounts (id INTEGER PRIMARY KEY, name text, original real, steam real, description text, photo int, ios int, android int, windows int, macos int, active int, zakazaka real, steampay real, steambuy real)")